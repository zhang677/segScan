...
int main(int argc, const char **argv) {
    ...
    if (mode == Mode::check) {
        ...
        out_feature.reset();
        csrspmm_seqreduce_rowbalance<Index,DType>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
        csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,2,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,2,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,2,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,2,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,2,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,2,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,2,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,2,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;
        /*
        csrspmm_parreduce_nnzbalance<Index,DType>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());checkSpMMsuffix;checkSpMMsuffix;
...
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,2,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
...
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,2,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,4,256,2,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,1,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,2,256,1,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,1>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,4>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
csrspmm_seqreduce_rowbalance_cg<Index,DType,1,256,0,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
        /*
        csrspmm_rowcaching_nnzbalance_cg<Index,DType,5,256,1,1,1,32>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
        csrspmm_rowcaching_nnzbalance_cg<Index,DType,5,256,1,1,1,16>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
        csrspmm_rowcaching_nnzbalance_cg<Index,DType,5,256,1,1,1,8>(H, feature_size, in_feature.d_array.get(),out_feature.d_array.get());
