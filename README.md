...
| 3090 | 1.083 | 0.110 | 1.078 | 16 | (3,256,2,1,1,8) |
| 2080 | 1.091 | 0.124 | 1.084 | 16 | (3,256,2,2,1,8) |
| V100 | 1.053 | 0.119 | 1.048 | 16 | (3,256,2,1,1,8) |
| 3090 | 1.081 | 0.171 | 1.071 | 4 | (2,256,1,2,1,32) |
| 2080 | 1.023 | 0.070 | 1.021 | 4 | (2,256,1,2,1,32) |
| V100 | 1.097 | 0.177 | 1.086 | 4 | (2,256,1,2,1,32) |

7. New static vs. dgSPARSE

ebpr

| Hardware | mean| geomean | N | Best static |
| :---:    | :----:| :---:| :---:| :---:| 
| 3090 | 1.465/1.455 | 1.431/1.426 | 128 | (5,256,5,1,32/16) |
| 2080 | 1.226/1.226 | 1.209/1.211 | 128 | (5,256,5,1,32/16) |
| V100 | 1.528/1.517 | 1.463/1.462 | 128 | (5,256,5,1,32/16) |
| 3090 | 1.401 | 1.383 | 64 | (5,256,5,1,8) |
| 2080 | 1.217 | 1.202 | 64 | (5,256,5,1,16) |
| V100 | 1.482 | 1.427 | 64 | (5,256,5,1,16) |
| 3090 | 1.327 | 1.310 | 16 | (5,256,5,1,8) |
| 2080 | 1.184/1.180 | 1.169/1.170 | 16 | (5,256,5,1,16/8) |
| V100 | 1.353 | 1.316 | 16 | (5,256,5,1,8) |
| 3090 | 1.200 | 1.185 | 4 | (5,256,5,1,4) |
| 2080 | 1.100 | 1.090| 4 | (5,256,5,1,4) |
| V100 | 1.166 | 1.144 | 4 | (5,256,5,1,4) |

rbpr

| Hardware | mean | geomean | N | Best static |
| :---:    | :----:| :---:| :---:| :---:| 
| 3090 | 2.279 | 2.042 | 128 | (3,256,3,1,2) |
| 2080 | 1.915 | 1.770 | 128 | (2,256,3,1,2) |
| V100 | 1.826 | 1.647 | 128 | (3,256,3,1,2) |
| 3090 | 2.163 | 1.892 | 64 | (3,256,3,1,2) |
| 2080 | 1.887 | 1.729| 64 | (2,256,3,1,2) |
| V100 | 1.746 | 1.550| 64 | (3,256,3,1,2) |
| 3090 | 1.868 | 1.524 | 16 | (3,256,3,1,2) |
| 2080 | 1.759 | 1.563 | 16 | (2,256,3,1,2) |
| V100 | 1.431 | 1.238 | 16 | (3,256,3,1,1) |
| 3090 | 1.854 | 1.456 | 4 | (3,256,3,1,1) |
| 2080 | 2.178 | 1.762 | 4 | (2,256,3,1,2) |
| V100 | 1.731 | 1.397| 4 | (3,256,3,1,1) |

ebsr

| Hardware | mean |  geomean | N | Best static |
| :---:    | :----:| :---:| :---:| :---:| 
| 3090 | 1.380/1.393 | 1.335/1.346 | 64 | (4,256,4,1,1,32/16) |
| 2080 | 1.624/1.623 | 1.605/1.603 | 64 | (4,256,4,1,1,32/16) |
| V100 | 1.449 | 1.430 | 64 | (4,256,4,1,1,16) |
| 3090 | 1.405 | 1.381 | 16 | (3,256,2,1,1,8) |
| 2080 | 1.442 | 1.421 | 16 | (3,256,2,2,1,8) |
| V100 | 1.381 | 1.359 | 16 | (3,256,2,1,1,8) |
| 3090 | 1.979 | 1.910 | 4 | (2,256,1,2,1,32) |
| 2080 | 2.102 | 2.076 | 4 | (2,256,1,2,1,32) |
| V100 | 1.903 | 1.833| 4 | (2,256,1,2,1,32) |
